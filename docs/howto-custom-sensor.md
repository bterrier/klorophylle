...
> *Inherited from WatchFlower (Emeric Grange, GPL v3); kept for reference. Paths and build names
> below refer to the upstream WatchFlower project, not to Klorophylle's layout.*
